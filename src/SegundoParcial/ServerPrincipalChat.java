 ...
 */
public class ServerPrincipalChat extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServerPrincipalChat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {                
                    final ServerPrincipalChat main;
                    main = new ServerPrincipalChat();
